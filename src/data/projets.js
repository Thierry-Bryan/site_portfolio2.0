export const projets = [
  {
    ...
    hero: {
      ...
      title: "ECHO SAFE",
      description: "Application solidaire pour lutter contre le harcèlement : messagerie sécurisée, mood tracker et kit de secours, pensée pour l'humain et la simplicité."
    },
    content: {
      description: "Echo Safe est né d'un constat aussi simple que révoltant : chaque année 15 million de personnes sont victimes de harcèlement, souvent livrées à elles-mêmes vers qui se tourner. Nous avons donc voulu offrir une application bienveillante où chaque victime puisse trouver un soutien rapide et personnel.",
      features: [
    ...
    images: {
      mockups: ["/projets/echosafe/echosafe-mockup-1.webp", "/projets/echosafe/echosafe-mockup-2.webp"],
      screens: ["/projets/echosafe/echosafe-screen-1.webp", "/projets/echosafe/echosafe-screen-2.webp"]
    }
  },
  {
    id: "12-fragments",
    ...
    hero: {
      ...
      title: "LES 12 FRAGMENTS",
      description: "Site créatif autour de 12 avatars pixel art, chacun avec son histoire, ses univers interactif et narratif unique."
    },
    content: {
      description: "Ce projet explore la création d'avatars personnalisables, intégralement conçus au pixel art via Illustrator.",
      features: [
    ...
    images: {
      ...
      screens: ["/projets/12-fragments/12-fragments-screen-1.webp", "/projets/12-fragments/12-fragments-screen-2.webp"]
    }
  },
  {
    id: "omnisphere",
    ...
    hero: {
      ...
      title: "OMNISPHERE",
      description: "Site immersif questionnant l'avenir des relations humaines avec design futuriste."
    },
    content: {
      description: "Omnisphere est un projet de réflexion sur l'évolution des interactions humaines dans un monde de plus en plus digitalisé.",
      features: [
  ...
  },
  {
    ...
    hero: {
      ...
      title: "ÇA VA TRAILER",
      description: "Vitrine immersive pour un festival de cinéma avec identité visuelle forte."
    },
    content: {
      description: "Site vitrine créé pour un festival de cinéma, mettant en avant l'identité visuelle et l'expérience immersive.",
      features: [
  ...
  },
  {
    ...
    hero: {
      ...
      title: "RBA",
      description: "Refonte complète de l'identité visuelle pour l'association biodiversité."
    },
    content: {
      description: "Projet de refonte complète de l'identité visuelle pour une association dédiée à la préservation de la biodiversité.",
      features: [
